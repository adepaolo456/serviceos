...
export default function Sidebar() {
    ...
    <>
            ...
            return (
              <li key={item.name}>
                <Link
                  ...
                  onMouseEnter={(e) => { if (!isActive) { e.currentTarget.style.backgroundColor = "var(--t-bg-card-hover)"; e.currentTarget.style.color = "var(--t-text-primary)"; } }}
                  onMouseLeave={(e) => { if (!isActive) { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "var(--t-text-muted)"; } }}
                >
                  <item.icon className="h-[18px] w-[18px] shrink-0" style={{ color: isActive ? "var(--t-accent)" : "var(--t-text-muted)" }} />
                  {item.name}
                </Link>
              </li>
            );
      ...
      <div className="px-3 pb-4 pt-2 space-y-1 shrink-0" style={{ borderTop: "1px solid var(--t-border)" }}>
        {user && (
          <div className="flex items-center gap-3 px-3 py-2.5">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-medium truncate" style={{ color: "var(--t-text-primary)" }}>{user.firstName} {user.lastName}</p>
              <p className="text-[11px] capitalize truncate" style={{ color: "var(--t-text-muted)" }}>{user.role}</p>
            </div>
          </div>
        )}
        <button onClick={cycleTheme} className="flex w-full items-center gap-3 rounded-[10px] px-3 py-2.5 text-sm transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
        ...
        {user?.email === "adepaolo456@gmail.com" && (
          <Link href="/admin" className="flex w-full items-center gap-3 rounded-[10px] px-3 py-2.5 text-sm transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
        ...
        <button onClick={handleLogout} className="flex w-full items-center gap-3 rounded-[10px] px-3 py-2.5 text-sm transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
  ...
  const collapsedSidebarContent = (
    <>
              ...
              <li key={item.name} className="relative">
                <Link
                  ...
                  onMouseEnter={(e) => {
                    ...
                    if (!isActive) { e.currentTarget.style.backgroundColor = "var(--t-bg-card-hover)"; e.currentTarget.style.color = "var(--t-text-primary)"; }
                  }}
                  onMouseLeave={(e) => {
                    setHoveredItem(null);
                    if (!isActive) { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "var(--t-text-muted)"; }
                  }}
                >
      ...
      {/* Footer — icons only */}
      <div className="px-2 pb-4 pt-2 space-y-1 shrink-0 flex flex-col items-center" style={{ borderTop: "1px solid var(--t-border)" }}>
        {user && (
        ...
        <div className="relative" onMouseEnter={() => setHoveredItem("_theme")} onMouseLeave={() => setHoveredItem(null)}>
          <button onClick={cycleTheme} className="flex h-11 w-11 items-center justify-center rounded-[10px] transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--t-bg-card-hover)"; e.currentTarget.style.color = "var(--t-text-primary)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "var(--t-text-muted)"; }}
          >
            {theme === "dark" ? <Sun className="h-[18px] w-[18px]" /> : <Moon className="h-[18px] w-[18px]" />}
        ...
        {user?.email === "adepaolo456@gmail.com" && (
          <div className="relative" onMouseEnter={() => setHoveredItem("_admin")} onMouseLeave={() => setHoveredItem(null)}>
            <Link href="/admin" className="flex h-11 w-11 items-center justify-center rounded-[10px] transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--t-accent-soft)"; e.currentTarget.style.color = "var(--t-accent)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "var(--t-text-muted)"; }}
            >
        ...
        <div className="relative" onMouseEnter={() => setHoveredItem("_logout")} onMouseLeave={() => setHoveredItem(null)}>
          <button onClick={handleLogout} className="flex h-11 w-11 items-center justify-center rounded-[10px] transition-all duration-150" style={{ color: "var(--t-text-muted)" }}
            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--t-error-soft)"; e.currentTarget.style.color = "var(--t-error)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "var(--t-text-muted)"; }}
          >
    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          >
            <button onClick={() => setMobileOpen(false)} className="absolute top-4 right-4 rounded-lg p-1.5" style={{ color: "var(--t-text-muted)" }}>
              <X className="h-5 w-5" />
            </button>
            {fullSidebarContent}
          </aside>
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.color = "var(--t-text-primary)"; e.currentTarget.style.borderColor = "var(--t-accent)"; }}
          onMouseLeave={(e) => { e.currentTarget.style.color = "var(--t-text-muted)"; e.currentTarget.style.borderColor = "var(--t-border)"; }}
        >
