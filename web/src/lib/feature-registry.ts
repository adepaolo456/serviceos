...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  exchange_new_size: { id: "exchange_new_size", label: "New dumpster size (optional)", category: "operations", shortDescription: "Label for optional new size on exchange.", guideDescription: "", routeOrSurface: "/rentals", tenantOverrideKey: "exchange_new_size", isUserFacing: true, isGuideEligible: false, keywords: ["exchange", "size"] },
