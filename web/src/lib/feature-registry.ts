...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  related_jobs: { id: "related_jobs", label: "Related Jobs", category: "operations", shortDescription: "Connected job lifecycle on the Job Detail page.", guideDescription: "The Related Jobs panel on the Job Detail page shows the full lifecycle of a service: delivery, exchange, and pickup. Jobs are connected by matching customer and service address in chronological order. Each related job shows its type, scheduled date, status, and a link to navigate directly. For exchange jobs, you can see both the original delivery and the upcoming pickup. This helps you understand the complete service timeline without switching between pages.", routeOrSurface: "job_detail", tenantOverrideKey: "related_jobs", isUserFacing: true, isGuideEligible: true, keywords: ["related", "connected", "lifecycle", "delivery", "pickup", "exchange"] },
