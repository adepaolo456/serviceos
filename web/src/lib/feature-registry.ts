...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  portal_action_change_pickup_date: { id: "portal_action_change_pickup_date", label: "Change Pickup Date", category: "customers", shortDescription: "CTA to extend or request early pickup for a rental.", guideDescription: "Change Pickup Date lets you adjust when your dumpster is picked up. Choose to extend your rental if you need more time, or request an early pickup if you're done sooner than expected. Select the option that fits your needs and pick a new date.", routeOrSurface: "portal", tenantOverrideKey: "portal_action_change_pickup_date", isUserFacing: true, isGuideEligible: true, keywords: ["change pickup", "extend", "early pickup", "reschedule"] },
