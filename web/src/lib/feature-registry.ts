...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  lifecycle_action_edit_pickup: { id: "lifecycle_action_edit_pickup", label: "Edit Pickup Date", category: "operations", shortDescription: "Edit the pickup date from the lifecycle page.", guideDescription: "Edit Pickup Date lets you change when the dumpster will be picked up directly from the lifecycle page. The pickup task date is updated immediately. Use this during a customer call to reschedule or change the pickup date without navigating away.", routeOrSurface: "/rentals", tenantOverrideKey: "lifecycle_action_edit_pickup", isUserFacing: true, isGuideEligible: true, keywords: ["edit", "pickup", "date", "reschedule"] },
  lifecycle_action_extend: { id: "lifecycle_action_extend", label: "Change Pickup Date", category: "operations", shortDescription: "Change the rental pickup date. Legacy id `lifecycle_action_extend` retained as the tenant override key.", guideDescription: "", routeOrSurface: "/rentals", tenantOverrideKey: "lifecycle_action_extend", isUserFacing: true, isGuideEligible: false, keywords: ["change", "pickup", "date", "rental"] },
