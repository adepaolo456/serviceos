...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  related_jobs: { id: "related_jobs", label: "Job Lifecycle", category: "operations", shortDescription: "Connected job lifecycle on the Job Detail page.", guideDescription: "The Job Lifecycle panel on the Job Detail page shows jobs that are directly connected to the current job through explicit parent/child linkage. A delivery shows its linked pickup or exchange. A pickup shows its originating delivery. Each related job displays its type, scheduled date, status, and a relationship label such as Original Delivery, Scheduled Pickup, or Current. Click any job to navigate directly to it. If no linked jobs exist, the panel shows a clear empty state rather than unrelated jobs.", routeOrSurface: "job_detail", tenantOverrideKey: "related_jobs", isUserFacing: true, isGuideEligible: true, keywords: ["related", "connected", "lifecycle", "delivery", "pickup", "exchange"] },
