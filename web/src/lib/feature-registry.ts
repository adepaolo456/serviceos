...
export const FEATURE_REGISTRY: Record<string, FeatureDescription> = {
  ...
  lifecycle_action_edit_pickup: { id: "lifecycle_action_edit_pickup", label: "Edit Pickup Date", category: "operations", shortDescription: "Edit the pickup date from the lifecycle page.", guideDescription: "Edit Pickup Date lets you change when the dumpster will be picked up directly from the lifecycle page. The pickup task date is updated immediately. Use this during a customer call to reschedule or extend a rental without navigating away.", routeOrSurface: "/rentals", tenantOverrideKey: "lifecycle_action_edit_pickup", isUserFacing: true, isGuideEligible: true, keywords: ["edit", "pickup", "date", "reschedule"] },
  lifecycle_action_extend: { id: "lifecycle_action_extend", label: "Extend Rental", category: "operations", shortDescription: "Extend the rental by setting a later pickup date.", guideDescription: "", routeOrSurface: "/rentals", tenantOverrideKey: "lifecycle_action_extend", isUserFacing: true, isGuideEligible: false, keywords: ["extend", "rental"] },
  ...
  customer_portal_extend: { id: "customer_portal_extend", label: "Extend Rental", category: "customers", shortDescription: "Reason code stamped by the portal extend-rental action.", guideDescription: "", routeOrSurface: "job_detail", tenantOverrideKey: "customer_portal_extend", isUserFacing: true, isGuideEligible: false, keywords: ["portal", "extend", "rental", "customer", "reschedule"] },
