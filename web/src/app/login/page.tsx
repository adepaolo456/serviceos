    ...
    <div className="flex min-h-screen items-center justify-center bg-dark-primary px-4">
      <div className="w-full max-w-sm">
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-all hover:bg-gray-50 active:scale-[0.98]"
        >
