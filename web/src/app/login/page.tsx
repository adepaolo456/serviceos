  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-dark-primary px-4">
      <div className="w-full max-w-sm">
        ...
        <button
          disabled
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60 disabled:cursor-not-allowed"
        >
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center"><span className="bg-dark-primary px-3 text-xs text-muted">or</span></div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-muted">
          ...
          <a href="/register" className="font-medium text-brand hover:text-brand-light transition-colors">Sign up</a>
        </p>
        <p className="mt-2 text-center text-sm text-muted">
          Want to see it in action?{" "}
          <a href="/demo" className="font-medium text-brand hover:text-brand-light transition-colors">Request a demo</a>
        </p>
      </div>
    </div>
  );
