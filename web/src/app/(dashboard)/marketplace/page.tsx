...
export default function MarketplacePage() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-[28px] font-bold tracking-[-1px] text-[var(--t-frame-text)]">RentThis Marketplace</h1>
        <p className="mt-1 text-[13px] text-[var(--t-frame-text-muted)]">Discover services and grow your business.</p>
      </div>

      <div className="flex flex-col items-center justify-center rounded-[20px] border border-[var(--t-border)] bg-[var(--t-bg-card)] p-20">
