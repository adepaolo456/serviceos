              ...
              <div className="grid grid-cols-3 gap-3">
                {TIME_WINDOWS.map((tw) => (
                  <button
                    ...
                    className={`rounded-[20px] border p-3 text-center transition-colors ${
                      timeWindow === tw.value
                        ? "border-[var(--t-accent)] bg-[var(--t-accent-soft)]"
                        : "border-[var(--t-border)] bg-[var(--t-bg-card)] hover:bg-[var(--t-bg-card-hover)]"
                    }`}
      ...
      {step === 5 && selectedService && priceBreakdown && (
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-[20px] border border-[var(--t-accent)] bg-[var(--t-accent-soft)] p-5">
          ...
          {error && <p className="mt-4 rounded-[20px] bg-[var(--t-error-soft)] border border-[var(--t-error)] px-4 py-3 text-sm text-[var(--t-error)]">{error}</p>}
        </div>
      )}
