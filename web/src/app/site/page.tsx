    ...
    <div>
        ...
        <section id="services" className="py-20 sm:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {allServices.map((s, i) => (
                <div key={i} className="rounded-[20px] border border-[var(--t-border)] bg-[var(--t-bg-card)] p-6 hover:bg-[var(--t-bg-card-hover)] transition-all group">
                  <div className="mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[20px] border border-[var(--t-border)] bg-[var(--t-bg-card)] mb-4">
      ...
      <section id="contact" className="py-20 sm:py-28 border-t border-[var(--t-border)]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          {tenant.about && (
            <div className="mt-12 rounded-[20px] border border-[var(--t-border)] bg-[var(--t-bg-card)] p-8">
